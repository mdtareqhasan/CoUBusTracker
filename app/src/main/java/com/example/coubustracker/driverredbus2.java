...
public class driverredbus2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driverredbus2);
    ...
    public void shareBus(View view) {
        ...
        if (!isValidHttpsLink(locationLink)) {
            Toast.makeText(this, "Only valid HTTPS-based live location links are allowed", Toast.LENGTH_SHORT).show();
            return;
        }

        BusLocation location = new BusLocation(driverName, mobileNumber, locationLink);
        busesRef.child("Red Bus 2").setValue(location)
    ...
    private boolean isValidHttpsLink(String link) {
    ...
    // 📥 Load current bus list from Firebase
    private void fetchBusList() {
        busesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot child : snapshot.getChildren()) {
                    ...
                    if (location != null) {
                        ...
                        int blackColor = ContextCompat.getColor(driverredbus2.this, android.R.color.black);
                        text1.setTextSize(18);
                        text2.setTextSize(16);
                        text1.setTextColor(blackColor);
                        text2.setTextColor(blackColor);

                        Button deleteButton = new Button(driverredbus2.this);
                        deleteButton.setText("Delete");
                        deleteButton.setTextSize(14);
                        deleteButton.setAllCaps(false);
                        deleteButton.setTextColor(ContextCompat.getColor(driverredbus2.this, android.R.color.white));
                        deleteButton.setBackgroundColor(ContextCompat.getColor(driverredbus2.this, android.R.color.holo_red_dark));
                        ...
                        LinearLayout container = new LinearLayout(driverredbus2.this);
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(driverredbus2.this, "Failed to load buses", Toast.LENGTH_SHORT).show();
            }
        });
    }
