...
public class studentevebus3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_studentevebus3);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        if (loc != null) {
                            ...
                            Toast.makeText(studentevebus3.this, "Eve Bus 3 not found", Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onCancelled(DatabaseError error) {
                        Toast.makeText(studentevebus3.this, "Error loading data", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        tvLocationLink.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(studentevebus3.this, WebViewActivity.class);
            intent.putExtra("busName", "Eve Bus 3");
