...
public class studentbluebus32 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_studentbluebus32);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        if (loc != null) {
                            ...
                            Toast.makeText(studentbluebus32.this, "Blue Bus 32 not found", Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onCancelled(DatabaseError error) {
                        Toast.makeText(studentbluebus32.this, "Error loading data", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        tvLocationLink.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(studentbluebus32.this, WebViewActivity.class);
            intent.putExtra("busName", "Blue Bus 32");
