...
public class studentevebus2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_studentevebus2);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        if (loc != null) {
                            ...
                            Toast.makeText(studentevebus2.this, "Eve Bus 2 not found", Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onCancelled(DatabaseError error) {
                        Toast.makeText(studentevebus2.this, "Error loading data", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        tvLocationLink.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(studentevebus2.this, WebViewActivity.class);
            intent.putExtra("busName", "Eve Bus 2");
