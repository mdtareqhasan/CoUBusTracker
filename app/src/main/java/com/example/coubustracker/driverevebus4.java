...
public class driverevebus4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driverevebus4);
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Eve Bus 4");
    ...
    public void shareBus(View view) {
        ...
        busesRef.child("Eve Bus 4").setValue(location)
    ...
    private void fetchBusList() {
        busesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot child : snapshot.getChildren()) {
                    ...
                    if (location != null) {
                        ...
                        int blackColor = ContextCompat.getColor(driverevebus4.this, android.R.color.black);
                        text1.setTextSize(18);
                        text2.setTextSize(16);
                        text1.setTextColor(blackColor);
                        text2.setTextColor(blackColor);

                        Button deleteButton = new Button(driverevebus4.this);
                        deleteButton.setText("Delete");
                        deleteButton.setTextSize(14);
                        deleteButton.setAllCaps(false);
                        deleteButton.setTextColor(ContextCompat.getColor(driverevebus4.this, android.R.color.white));
                        deleteButton.setBackgroundColor(ContextCompat.getColor(driverevebus4.this, android.R.color.holo_red_dark));
                        ...
                        LinearLayout container = new LinearLayout(driverevebus4.this);
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(driverevebus4.this, "Failed to load buses", Toast.LENGTH_SHORT).show();
            }
        });
    }
