...
public class studentredbus5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        if (loc != null) {
                            ...
                            Toast.makeText(studentredbus5.this, "Red Bus 5 not found", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        tvLocationLink.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(studentredbus5.this, WebViewActivity.class);
            intent.putExtra("busName", "Red Bus 5");
