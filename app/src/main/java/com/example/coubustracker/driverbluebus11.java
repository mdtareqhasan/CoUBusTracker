...
public class driverbluebus11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driverbluebus11);
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Blue Bus 11");
    ...
    public void shareBus(View view) {
        ...
        busesRef.child("Blue Bus 11").setValue(location)
    ...
    private void fetchBusList() {
        busesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot child : snapshot.getChildren()) {
                    ...
                    if (location != null) {
                        ...
                        int blackColor = ContextCompat.getColor(driverbluebus11.this, android.R.color.black);
                        text1.setTextSize(18);
                        text2.setTextSize(16);
                        text1.setTextColor(blackColor);
                        text2.setTextColor(blackColor);

                        Button deleteButton = new Button(driverbluebus11.this);
                        deleteButton.setText("Delete");
                        deleteButton.setTextSize(14);
                        deleteButton.setAllCaps(false);
                        deleteButton.setTextColor(ContextCompat.getColor(driverbluebus11.this, android.R.color.white));
                        deleteButton.setBackgroundColor(ContextCompat.getColor(driverbluebus11.this, android.R.color.holo_red_dark));
                        ...
                        LinearLayout container = new LinearLayout(driverbluebus11.this);
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(driverbluebus11.this, "Failed to load buses", Toast.LENGTH_SHORT).show();
            }
        });
    }
