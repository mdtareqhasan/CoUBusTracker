...
public class driverbluebus33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driverbluebus33);
    ...
    public void shareBus(View view) {
        ...
        busesRef.child("Blue Bus 33").setValue(location)
    ...
    private void fetchBusList() {
        busesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot child : snapshot.getChildren()) {
                    ...
                    if (location != null) {
                        ...
                        int blackColor = ContextCompat.getColor(driverbluebus33.this, android.R.color.black);
                        text1.setTextSize(18);
                        text2.setTextSize(16);
                        text1.setTextColor(blackColor);
                        text2.setTextColor(blackColor);

                        Button deleteButton = new Button(driverbluebus33.this);
                        deleteButton.setText("Delete");
                        deleteButton.setTextSize(14);
                        deleteButton.setAllCaps(false);
                        deleteButton.setTextColor(ContextCompat.getColor(driverbluebus33.this, android.R.color.white));
                        deleteButton.setBackgroundColor(ContextCompat.getColor(driverbluebus33.this, android.R.color.holo_red_dark));
                        ...
                        LinearLayout container = new LinearLayout(driverbluebus33.this);
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(driverbluebus33.this, "Failed to load buses", Toast.LENGTH_SHORT).show();
            }
        });
    }
