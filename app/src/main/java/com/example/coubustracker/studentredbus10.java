...
public class studentredbus10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_studentredbus10);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        if (loc != null) {
                            ...
                            Toast.makeText(studentredbus10.this, "Red Bus 10 not found", Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onCancelled(DatabaseError error) {
                        Toast.makeText(studentredbus10.this, "Error loading data", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        tvLocationLink.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(studentredbus10.this, WebViewActivity.class);
            intent.putExtra("busName", "Red Bus 10");
